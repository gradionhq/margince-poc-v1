...
4. Deep dives on demand: [write-backbone.md](explanation/write-backbone.md), [composition-layer.md](explanation/composition-layer.md), [job-fleet.md](explanation/job-fleet.md), [agent-surface.md](explanation/agent-surface.md), [ai-runtime.md](explanation/ai-runtime.md), [search-and-retrieval.md](explanation/search-and-retrieval.md), [company-context.md](explanation/company-context.md), [privacy-and-consent.md](explanation/privacy-and-consent.md), [custom-fields.md](explanation/custom-fields.md), [automation.md](explanation/automation.md), [capture-connectors.md](explanation/capture-connectors.md), [outbound-messaging.md](explanation/outbound-messaging.md), [relationship-graph.md](explanation/relationship-graph.md), [outbound-webhooks.md](explanation/outbound-webhooks.md), [reference/modules.md](reference/modules.md), [reference/platform-toolkit.md](reference/platform-toolkit.md).
   Working on the SPA? [frontend-architecture.md](explanation/frontend-architecture.md) first.
