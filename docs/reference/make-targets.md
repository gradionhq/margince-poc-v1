...
| `test-one-spelling` | Plants each of those three defects, and each lookalike that must NOT fire, in the scanned tree and asserts the gate's verdict on all nine |
