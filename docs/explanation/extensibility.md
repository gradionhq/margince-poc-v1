...
| The published record type cannot silently fall behind the core's capture envelope: every field is mirrored or waived with its reason | `backend/extingressdrift_test.go` |
