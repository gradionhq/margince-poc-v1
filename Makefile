...
## license-module — refresh the bundled license-validation wasm module from the
## margince-constellation release it is pinned to, verifying the download
## against the digest GitHub reports and rewriting the recorded pin beside it.
## Pass a tag to move the pin: `make license-module TAG=sha-<commit>`. Needs a
## gh login with access to that private repository; nothing else in the build
## does, because the module itself is committed.
license-module:
	./scripts/fetch-license-module.sh $(TAG)
