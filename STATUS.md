...
- Open, in draft (2026-08-14): **twelve configuration pages in the record page's
  voice** ([#1225](https://github.com/gradionhq/margince-poc-v1/pull/1225)). Not
  ready for review — the founder wants a manual frontend pass first. Settings and
  ...
  `sub` prop, so several surfaces hand-roll the subtitle margin.
