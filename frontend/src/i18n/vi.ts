...
export const vi = {
  ...
  "trust.originSiteRead": "Lấy từ trang web",
  "trust.originConnector": "Nhận từ hệ thống kết nối",
  "trust.originMigration": "Nhập từ hệ thống trước đây",
  ...
  "agent.exampleCost": "€2.41 hôm nay",
  ...
  "co.company.title": "Công ty",
  "co.company.website": "Trang web",
  "co.company.legalName": "Tên pháp lý",
  "co.company.industry": "Ngành",
  "co.company.size": "Quy mô",
  "co.company.owner": "Phụ trách",
  "co.company.added": "Đã thêm",
  ...
  "co.strip.commitments.none": "Không có",
  "co.strip.overdueCount": "{count} quá hạn",
  ...
  "co.brief.section.activity": "Hoạt động gần đây",
  ...
  "co.health.title": "Mối quan hệ",
  "co.website.title": "Đọc website của họ",
  "co.health.empty": "Không có điều gì đáng lưu ý.",
  ...
  "record.business": "Về bản ghi này",
