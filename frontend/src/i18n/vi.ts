...
export const vi = {
  ...
  "contracts.col.contract": "H\u1ee3p \u0111\u1ed3ng",
  "contracts.col.reference": "M\u00e3 tham chi\u1ebfu",
  "contracts.col.value": "Gi\u00e1 tr\u1ecb",
  "contracts.col.status": "Tr\u1ea1ng th\u00e1i",
  "contracts.col.term": "Th\u1eddi h\u1ea1n",
  ...
  "docs.col.document": "Tài liệu",
  "docs.col.type": "Loại",
  "docs.col.version": "Phiên bản",
  "docs.col.added": "Đã thêm",
