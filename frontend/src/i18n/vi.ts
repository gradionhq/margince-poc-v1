...
export const vi = {
  ...
  "today.tile.lastInteraction": "Trao đổi thực chất gần nhất",
  "today.tile.opportunity": "Cơ hội đang chạy",
  "today.tile.risk": "Rủi ro",
  "today.tile.since": "Từ lần bạn ghé gần nhất",
  ...
  "today.interaction.theyWrote": "Họ đã viết cho ta",
  "today.interaction.weWrote": "Ta đã viết cho họ",
