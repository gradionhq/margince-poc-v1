...
export const vi = {
  ...
  "lead.signal.fact": "sự thật",
  "lead.signal.assumption": "giả định",
  "lead.signal.judgement": "đánh giá",
  ...
  "person.activity.empty": "Chưa ghi nhận trao đổi nào với họ.",
  ...
  "person.files.empty": "Chưa có tệp nào lưu cho liên hệ này.",
