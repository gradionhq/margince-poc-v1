...
export const vi = {
  ...
  // Thanh tác vụ agent ở cuối màn hình (app/agenttaskbar.tsx) — bề mặt agent
  // duy nhất, hiển thị trên mọi màn hình. `taskbar.task.*` là token nơi tác
  // vụ được gọi trên hệ thống (`growth_fit`, `site_fact_extract`, …), viết
  // lại bằng lời của người đọc; một tác vụ chưa có ở đây sẽ quay về token
  // gốc với dấu gạch dưới được mở ra.
  "taskbar.onThisPage": "Trên trang này",
  "taskbar.acrossWorkspace": "Trong toàn bộ workspace",
  "taskbar.runtime": "Thời gian chạy",
  "taskbar.recap": "Những gì đã thực hiện",
  "taskbar.justNow": "vừa xong",
  "taskbar.fullLog": "Xem toàn bộ nhật ký",
  "taskbar.logUnreadable": "Nhật ký cuộc gọi không đọc được với chỗ này",
  "taskbar.model": "mô hình",
  "taskbar.tools": "công cụ",
  "taskbar.approvals": "Phê duyệt đang chờ",
  "taskbar.offline": "ngoại tuyến",
  "taskbar.idle": "Không hoạt động",
  "taskbar.reading": "Đang tải",
  "taskbar.readingRecord": "Đang đọc bản ghi này",
  "taskbar.working": "Đang xử lý",
  "taskbar.unreachable": "Không kết nối được tới Margince",
  "taskbar.waiting": "đang chờ bạn",
  "taskbar.cannotReach": "Không thể kết nối tới",
  "taskbar.review": "Xem",
  ...
  "taskbar.collapse": "Thu gọn bảng agent",
  "taskbar.region": "Thanh tác vụ Margince AI",
  "taskbar.unreadable": "không đọc được với chỗ này",
  "taskbar.noCallsYet": "chưa có gì được chạy",
  "taskbar.task.agent_loop": "Đã xử lý một yêu cầu",
  "taskbar.task.brief_ranking": "Đã xếp hạng bản tóm tắt buổi sáng của bạn",
  "taskbar.task.capture_classify": "Đã phân loại thư đã thu thập",
  "taskbar.task.capture_counterparty_verdict":
    "Đã xác định người liên quan trong một tin nhắn",
  "taskbar.task.cert_judge": "Đã tự kiểm tra câu trả lời của mình",
  "taskbar.task.cold_start": "Đã thiết lập workspace của bạn",
  "taskbar.task.deal_health": "Đã đọc tình trạng của một deal",
  "taskbar.task.document_extract":
    "Đã trích xuất trường dữ liệu từ một tài liệu",
  "taskbar.task.draft_reply": "Đã soạn một câu trả lời",
  "taskbar.task.enrich": "Đã bổ sung thông tin liên hệ",
  "taskbar.task.growth_fit": "Đã chấm điểm mức độ phù hợp của một công ty",
  "taskbar.task.nl_search": "Đã trả lời một tìm kiếm",
  "taskbar.task.offer_draft": "Đã soạn một đề nghị",
  "taskbar.task.rate_extract": "Đã đọc bảng giá từ một trang",
  "taskbar.task.signal_extract":
    "Đã tìm thấy tín hiệu trong một chuỗi hội thoại",
  "taskbar.task.site_extract": "Đã đọc website của một công ty",
  "taskbar.task.site_fact_extract": "Đã trích xuất thông tin từ một trang web",
  "taskbar.task.site_triage": "Đã chọn những trang cần đọc",
  "taskbar.task.summarize": "Đã viết một bản tóm tắt",
  "taskbar.task.transcript": "Đã xử lý bản ghi cuộc gọi",
  "taskbar.task.transcript_propose":
    "Đã đề xuất bước tiếp theo từ một cuộc gọi",
  "taskbar.task.voice_build": "Đã học văn phong viết của bạn",
  ...
  "co.brief.title": "Tài khoản này, tóm tắt",
  ...
  "co.connections.intro.askForIntro": "Đề nghị được giới thiệu",
  "co.connections.intro.writeDirectly": "Viết thư trực tiếp",
  "co.connections.intro.via": "Qua",
  ...
  "lead.segregated": "Ưu tiên theo hạn phản hồi và điểm đánh giá.",
  ...
  "inbox.tokenOnce": "Sao chép ngay — token này chỉ hiển thị một lần.",
  "inbox.copy": "Sao chép",
  "inbox.copied": "Đã sao chép",
  "inbox.tokenDone": "Xong",
  ...
  "tasks.today": "Hôm nay",
  "tasks.upcoming": "Sắp tới",
  "tasks.undated": "Không có hạn",
  ...
  "tasks.subject": "Tiêu đề",
  "tasks.dueDate": "Ngày đến hạn",
  "tasks.remindAt": "Nhắc tôi lúc",
  ...
  "dedupe.undone": "Đã mở lại cặp này.",
  "dedupe.dismissNote": "Bỏ qua",
  ...
  "users.role.management": "Ban lãnh đạo",
  "users.role.manager": "Trưởng nhóm",
  "users.role.rep": "Thành viên",
  ...
  "person.page.asideLabel": "Bối cảnh quan hệ",
  ...
  "person.rail.colleagueOne": "1 đồng nghiệp",
  "person.rail.colleagues": "{count} đồng nghiệp",
