...
export const vi = {
  ...
  "record.tabs": "Xem gì về bản ghi này",
  ...
  "co.deals.col.name": "Thương vụ",
  "co.deals.col.stage": "Giai đoạn",
  "co.deals.col.amount": "Giá trị",
  "co.deals.col.close": "Dự kiến chốt",
  "co.deals.col.state": "Trạng thái",
  "co.deals.noAmount": "Chưa định giá",
  "co.deals.noClose": "Chưa có ngày",
