...
export const vi = {
  ...
  "commercial.title": "Quan hệ thương mại",
  "commercial.noneOpen": "Tài khoản này không có cơ hội nào đang mở.",
  "commercial.openOpportunities": "Cơ hội đang mở",
  "commercial.unpriced": "Chưa định giá",
  ...
  "today.deal.atLeast": "{count}+ deal đang mở",
  "today.deal.seePipeline": "Quá nhiều để xếp hạng ở đây — xem pipeline",
  ...
  "today.route.remainder": "{count} đồng nghiệp khác từng trao đổi với họ",
