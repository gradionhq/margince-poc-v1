...
export const en = {
  ...
  "ob.readStatus.failed": "Manual input needed",
  "ob.readStatus.confirmed": "Confirmed",
  "ob.readStatus.abandoned": "Stopped",
  "ob.phaseDiscover": "Discover pages",
  "ob.phaseExtract": "Extract grounded facts",
  "ob.phaseReady": "Prepare review",
  "ob.pagesRead": "pages read",
  "ob.profileFindings": "profile findings",
  "ob.usefulFacts": "useful facts",
  "ob.coverageDetails": "Coverage and honest omissions",
  "ob.confirmWebsite":
  ...
  "auto.preview.matchesNow": "{n} match now",
