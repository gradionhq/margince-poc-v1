...
export const en = {
  ...
  "compose.audienceWorkspace": "Everyone in the workspace",
  "compose.audienceWorkspaceHint": "Anyone who may see the contact reads this message too.",
  "compose.audienceParticipants": "Participants only",
  "compose.audienceParticipantsHint": "Only the people on this message read its subject and body. Others see that a message was exchanged that day, nothing more.",
  "compose.audienceConfirm": "Save visibility",
  "compose.audienceNote": "Applies to this message only \u2014 not to the thread and not to the contact.",
