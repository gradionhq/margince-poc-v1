...
export const en = {
  ...
  "person.thin.known": "We have {what} for {name}, but nobody here has a recorded exchange with them yet.",
  "person.thin.remediation.capture": "Connect the mailbox that writes to them, and this page fills itself in — every field with the source it came from.",
  "person.thin.remediation.employer": "Add their employer and Margince can read that company's site for their role.",
  ...
  "person.pulse.nobodyYet": "Nobody here has a recorded exchange with them yet.",
  ...
  "person.pulse.arithmetic": "Score {score}/100 = 100 x recency {recency} x frequency {frequency} x reciprocity {reciprocity}. Computed at read from captured cadence, never stored.",
  ...
  "person.consent.noneGranted": "No purpose is granted, so outbound stays blocked.",
