...
export const en = {
  ...
  "jobs.waitedSeconds": "oldest has waited {count} seconds",
  "jobs.waitedMinutes": "oldest has waited {count} minutes",
  "jobs.waitedHours": "oldest has waited {count} hours",
  "jobs.waitedDays": "oldest has waited {count} days",
