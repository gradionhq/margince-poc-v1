...
export const en = {
  ...
  // The bottom agent taskbar (app/agenttaskbar.tsx) — the one agent surface,
  // drawn on every screen. `taskbar.task.*` is the wire's invocation-site
  // token (`growth_fit`, `site_fact_extract`, …) said in the reader's words;
  // a task with no entry here falls back to its token with the underscores
  // opened up, so a task added upstream still reads instead of vanishing.
  "taskbar.onThisPage": "On this page",
  "taskbar.acrossWorkspace": "Across the workspace",
  "taskbar.runtime": "Runtime",
  "taskbar.recap": "What it has done",
  "taskbar.justNow": "just now",
  "taskbar.fullLog": "Full log",
  "taskbar.logUnreadable": "The call log is not readable on this seat",
  "taskbar.model": "model",
  "taskbar.tools": "tools",
  "taskbar.approvals": "Approvals waiting",
  "taskbar.offline": "offline",
  "taskbar.idle": "Idle",
  "taskbar.reading": "Loading",
  "taskbar.readingRecord": "Reading this record",
  "taskbar.working": "Working",
  "taskbar.unreachable": "Cannot reach Margince",
  "taskbar.waiting": "waiting for you",
  "taskbar.cannotReach": "Cannot reach",
  "taskbar.review": "Review",
  ...
  "taskbar.collapse": "Collapse the agent panel",
  "taskbar.region": "Margince AI taskbar",
  "taskbar.unreadable": "not readable on this seat",
  "taskbar.noCallsYet": "nothing has run yet",
  "taskbar.task.agent_loop": "Worked through a request",
  "taskbar.task.brief_ranking": "Ranked your morning brief",
  "taskbar.task.capture_classify": "Sorted captured mail",
  "taskbar.task.capture_counterparty_verdict": "Decided who a message was with",
  "taskbar.task.cert_judge": "Checked its own answer",
  "taskbar.task.cold_start": "Set up your workspace",
  "taskbar.task.deal_health": "Read the health of a deal",
  "taskbar.task.document_extract": "Pulled fields out of a document",
  "taskbar.task.draft_reply": "Drafted a reply",
  "taskbar.task.enrich": "Filled in contact details",
  "taskbar.task.growth_fit": "Scored how well a company fits",
  "taskbar.task.nl_search": "Answered a search",
  "taskbar.task.offer_draft": "Drafted an offer",
  "taskbar.task.rate_extract": "Read pricing off a page",
  "taskbar.task.signal_extract": "Found signals in a thread",
  "taskbar.task.site_extract": "Read a company website",
  "taskbar.task.site_fact_extract": "Pulled facts off a web page",
  "taskbar.task.site_triage": "Picked which pages to read",
  "taskbar.task.summarize": "Wrote a summary",
  "taskbar.task.transcript": "Processed a call transcript",
  "taskbar.task.transcript_propose": "Proposed next steps from a call",
  "taskbar.task.voice_build": "Learned your writing voice",
  ...
  "co.details.address": "Address",
  "co.health.title": "How it stands",
  "co.health.empty": "No health reading on this account yet.",
  ...
  "co.brief.title": "The account, in short",
  ...
  "lead.status": "Status",
  "lead.segregated":
    "Prioritized by response deadline and qualification score.",
  ...
  "person.rail.nextActions": "Next best actions",
