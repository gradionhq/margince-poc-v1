...
export const en = {
  ...
  "trust.originSiteRead": "Read from the website",
  "trust.originConnector": "Received from a connected system",
  "trust.originMigration": "Imported from a previous system",
  ...
  "co.company.title": "The company",
  "co.company.website": "Website",
  "co.company.legalName": "Legal name",
  "co.company.industry": "Industry",
  "co.company.size": "Size",
  "co.company.owner": "Owner",
  "co.company.added": "Added",
  ...
  "co.strip.commitments.none": "None",
  "co.strip.overdueCount": "{count} overdue",
  ...
  "co.brief.section.activity": "Recent activity",
  ...
  "record.business": "About this record",
