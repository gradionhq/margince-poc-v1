...
export const en = {
  ...
  "record.tabs": "What to read about this record",
  ...
  "co.deals.col.stage": "Stage",
  "co.deals.col.amount": "Value",
  "co.deals.col.close": "Expected close",
  "co.deals.col.state": "State",
  "co.deals.noAmount": "Not priced",
  "co.deals.noClose": "No date",
