...
export const de = {
  ...
  "co.pulse.strengthTail.one": "von 1 Kontakt",
  "co.pulse.strengthTail.other": "von {count} Kontakten",
  ...
  "co.reach.window": "Kontakt der letzten 90 Tage",
  ...
  "co.read.singleThread":
    "Nur {name} zeigt in den letzten {days} Tagen E-Mails, Anrufe oder Termine.",
