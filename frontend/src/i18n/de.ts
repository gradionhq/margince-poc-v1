...
export const de = {
  ...
  "person.thin.known": "Wir haben {what} zu {name}, aber niemand hier hat bisher einen erfassten Austausch mit ihnen.",
  "person.thin.remediation.capture": "Verbinden Sie das Postfach, das mit ihnen schreibt - dann fuellt sich diese Seite von selbst, jedes Feld mit seiner Quelle.",
  "person.thin.remediation.employer": "Hinterlegen Sie den Arbeitgeber, dann liest Margince dessen Website nach ihrer Rolle.",
  ...
  "person.pulse.nobodyYet": "Niemand hier hat bisher einen erfassten Austausch mit ihnen.",
  ...
  "person.pulse.arithmetic": "Wert {score}/100 = 100 x Aktualitaet {recency} x Haeufigkeit {frequency} x Gegenseitigkeit {reciprocity}. Beim Lesen berechnet, nie gespeichert.",
  ...
  "person.consent.noneGranted": "Kein Zweck ist eingewilligt, ausgehende Nachrichten bleiben blockiert.",
