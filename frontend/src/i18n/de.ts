...
export const de = {
  ...
  "co.strip.commitments.none": "Keine",
  "co.strip.overdueCount": "{count} überfällig",
  ...
  "tab.deals": "Deals",
  "tab.context": "Kontext",
  "timeline.period.thisWeek": "Diese Woche",
  "timeline.period.lastWeek": "Letzte Woche",
  "timeline.period.upcoming": "Bevorstehend",
  ...
  "record.tabs": "Was über diesen Datensatz gelesen wird",
  ...
  "commercial.title": "Geschäftsbeziehung",
  "commercial.noneOpen": "Keine offene Opportunity zu diesem Account.",
  "commercial.openOpportunities": "Offene Opportunities",
  "commercial.unpriced": "Nicht bepreist",
  ...
  "co.deals.col.name": "Deal",
  "co.deals.col.stage": "Phase",
  "co.deals.col.amount": "Wert",
  "co.deals.col.close": "Erwarteter Abschluss",
  "co.deals.col.state": "Status",
  "co.deals.noAmount": "Kein Preis",
  "co.deals.noClose": "Kein Datum",
  ...
  "timeline.gap": "Zwischen {from} und {to} ist nichts passiert.",
  ...
  "today.deal.atLeast": "{count}+ offene Deals",
  "today.deal.seePipeline": "Zu viele für eine Reihung hier — siehe Pipeline",
  ...
  "today.route.remainder": "{count} weitere Kolleginnen haben Kontakt gehabt",
