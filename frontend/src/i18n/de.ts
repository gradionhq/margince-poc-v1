...
export const de = {
  ...
  // Die untere Agenten-Taskleiste (app/agenttaskbar.tsx) — die eine
  // Agentenoberfläche, auf jedem Bildschirm eingeblendet. `taskbar.task.*`
  // ist das Einsatzstellen-Token der Schnittstelle (`growth_fit`,
  // `site_fact_extract`, …) in Worten der Leserin; eine Aufgabe ohne Eintrag
  // fällt hier auf ihr Token mit aufgelösten Unterstrichen zurück.
  "taskbar.onThisPage": "Auf dieser Seite",
  "taskbar.acrossWorkspace": "Im gesamten Workspace",
  "taskbar.runtime": "Laufzeit",
  "taskbar.recap": "Was bisher erledigt wurde",
  "taskbar.justNow": "gerade eben",
  "taskbar.fullLog": "Vollständiges Protokoll",
  "taskbar.logUnreadable": "Das Protokoll ist auf diesem Sitz nicht lesbar",
  "taskbar.model": "Modell",
  "taskbar.tools": "Werkzeuge",
  "taskbar.approvals": "Freigaben offen",
  "taskbar.offline": "offline",
  "taskbar.idle": "Inaktiv",
  "taskbar.reading": "Wird geladen",
  "taskbar.readingRecord": "Liest diesen Datensatz",
  "taskbar.working": "Arbeitet",
  "taskbar.unreachable": "Margince ist nicht erreichbar",
  "taskbar.waiting": "wartet auf dich",
  "taskbar.cannotReach": "Kein Zugriff auf",
  "taskbar.review": "Prüfen",
  ...
  "taskbar.collapse": "Agenten-Panel einklappen",
  "taskbar.region": "Margince-KI-Taskleiste",
  "taskbar.unreadable": "auf diesem Sitz nicht lesbar",
  "taskbar.noCallsYet": "bisher nichts ausgeführt",
  "taskbar.task.agent_loop": "Eine Anfrage bearbeitet",
  "taskbar.task.brief_ranking": "Dein Morgenbriefing sortiert",
  "taskbar.task.capture_classify": "Erfasste E-Mails sortiert",
  "taskbar.task.capture_counterparty_verdict":
    "Entschieden, mit wem eine Nachricht war",
  "taskbar.task.cert_judge": "Die eigene Antwort geprüft",
  "taskbar.task.cold_start": "Deinen Workspace eingerichtet",
  "taskbar.task.deal_health": "Den Zustand eines Deals gelesen",
  "taskbar.task.document_extract": "Felder aus einem Dokument extrahiert",
  "taskbar.task.draft_reply": "Eine Antwort entworfen",
  "taskbar.task.enrich": "Kontaktdaten ergänzt",
  "taskbar.task.growth_fit": "Bewertet, wie gut ein Unternehmen passt",
  "taskbar.task.nl_search": "Eine Suche beantwortet",
  "taskbar.task.offer_draft": "Ein Angebot entworfen",
  "taskbar.task.rate_extract": "Preise von einer Seite gelesen",
  "taskbar.task.signal_extract": "Signale in einem Thread gefunden",
  "taskbar.task.site_extract": "Eine Unternehmens-Website gelesen",
  "taskbar.task.site_fact_extract": "Fakten von einer Webseite extrahiert",
  "taskbar.task.site_triage": "Ausgewählt, welche Seiten zu lesen sind",
  "taskbar.task.summarize": "Eine Zusammenfassung geschrieben",
  "taskbar.task.transcript": "Ein Anruf-Transkript verarbeitet",
  "taskbar.task.transcript_propose":
    "Nächste Schritte aus einem Anruf vorgeschlagen",
  "taskbar.task.voice_build": "Deinen Schreibstil gelernt",
  ...
  "co.brief.title": "Der Account, kurz gefasst",
  ...
  "co.connections.intro.askForIntro": "Um eine Vorstellung bitten",
  "co.connections.intro.writeDirectly": "Direkt schreiben",
  "co.connections.intro.via": "Über",
  ...
  "lead.score": "Score",
  "lead.status": "Status",
  "lead.segregated": "Priorisiert nach Antwortfrist und Qualifikationsscore.",
  ...
  "users.role.management": "Geschäftsleitung",
  "users.role.manager": "Teamleitung",
  "users.role.rep": "Mitglied",
  ...
  "person.today.heading": "Heute mit {name}",
  "person.today.source": "{count} Beleg",
  "person.today.sources": "{count} Belege",
  ...
  "person.rail.colleagueOne": "1 Kollege",
  "person.rail.colleagues": "{count} Kolleginnen und Kollegen",
