...
export interface components {
    schemas: {
        ...
        PublicEventDealRoomParticipantInvited: {
            ...
            /** @description view, comment or reviewer. */
            capability: string;
        };
        /**
        ...
        /**
         * @description Payload for deal_room.published — a human published a release, fixing exactly
         *     what the buyer now reads. Release 1 is the room going live for the first time.
         */
        PublicEventDealRoomPublished: {
            /** Format: uuid */
            deal_id: string;
            /** @description Monotonic per room, from 1. */
            release_no: number;
            /** Format: uuid */
            release_id?: string;
        };
        ...
        /**
         * @description Payload for deal_room.task_completion_changed — an item on the shared to-do
         ...
         */
        PublicEventDealRoomTaskCompletionChanged: {
            /** Format: uuid */
            deal_id: string;
            /** Format: uuid */
            task_id: string;
            /** @description Which side owed the item — `seller` or `buyer`. */
            side: string;
            /** @description Its state after the change. False means a completed item was re-opened. */
            done: boolean;
        };
