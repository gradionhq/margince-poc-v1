...
export interface paths {
    ...
    "/organizations/{id}/graph": {
         ...
         *     exactly the top N. Contacts are ordered by a relationship strength computed after
         *     the read, so an account with more than 500 contacts contributes the strongest of
         *     the first 500 by id rather than of all of them; `dropped_count` is still the true
         *     remainder. No real account is near that bound, and an installation that reaches it
