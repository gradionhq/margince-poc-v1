...
export interface paths {
    ...
    "/organizations/{id}/graph": {
         ...
         *     out; a truncated graph with no count reads as the whole neighbourhood. Stakeholder
         *     contacts have no cap of their own — they are bounded by the deals already
         *     selected — so they are the one node kind that number does not speak for.
         *
         *     Native system-of-record only: a workspace reading from an incumbent mirror gets
