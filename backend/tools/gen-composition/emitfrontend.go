...
func emitComposedFrontendWorkspace(dir string, units []string) error {
  ...
  "private": true,
  "version": "0.0.0",
  "//": "GENERATED by tools/gen-composition. The composed frontend workspace root: its members are every enabled unit's frontend layer. Do not edit; do not commit (build/ is ignored).",
  "pnpm": {
    "overrides": {
