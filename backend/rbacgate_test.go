...
var ungatedEntryPoints = map[string]string{ // #nosec G101 -- waiver rationales for the fitness gate, not credentials
	...
	"internal/modules/search:SweepEmbeddingDrift":             "periodic worker sweep (ADR-0069 §3a): heals identity-matched embedding gaps under the system principal, same posture as ReembedCorpus — no request, no human actor to gate",
