...
ALTER TABLE person_consent ADD COLUMN lead_id uuid NULL;
ALTER TABLE person_consent ADD CONSTRAINT person_consent_lead_id_fkey
...
ALTER TABLE consent_event ADD COLUMN lead_id uuid NULL;
ALTER TABLE consent_event ADD CONSTRAINT consent_event_lead_id_fkey
