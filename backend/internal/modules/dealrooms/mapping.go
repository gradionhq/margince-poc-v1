...
func inviteInput(req crmcontracts.InviteDealRoomParticipantRequest) (InviteInput, error) {
	if strings.TrimSpace(req.FullName) == "" {
		return InviteInput{}, &fieldError{field: "full_name", code: "required", msg: "full_name is required"}
	}
	if err := provenance.Refuse("source", req.Source); err != nil {
...
func participantUpdateInput(req crmcontracts.UpdateDealRoomParticipantRequest) UpdateParticipantInput {
