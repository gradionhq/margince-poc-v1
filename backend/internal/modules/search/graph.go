...
type graphItem struct {
	...
	// timeline can say "raised on 2025-09-13"; one that has only the prose has
	// to take a date from whatever a note recalls, and a note recalling
	// "October" for a September email is the reading that reaches the customer.
	// Zero for a record that is not an event (a person, an organization).
