...
const stageIDNote = `,"description":"The target stage. A deal you have read carries the stage it is IN; list_pipelines is what yields the stages it could move to. That stage's semantic decides what happens next: open executes immediately, won or lost is staged for a human's approval."`
