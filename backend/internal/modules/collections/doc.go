...
// events.md closed catalog defines no list.*/tag.* types (filed as
// feedback), so these ride the same ratified audit-only lane as
// pipeline config until the spec adds them.
//
