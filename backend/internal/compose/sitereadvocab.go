...
var categoryGuidance = map[string]string{
	...
	"offering": "service and product name what the company sells — one entry per item, repeating the field name.",
	"signal": "certification names a held certification or standard; partner a named business partner; " +
		...
		"works with or builds on — one entry per item, repeating the field name.",
}
