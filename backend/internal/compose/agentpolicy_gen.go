...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/offers/{id}/line-items/{lineItemId}":   {Op: "removeOfferLineItem", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "dynamic"},
	...
	"PATCH /v1/offers/{id}":                            {Op: "updateOffer", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "dynamic"},
	"PATCH /v1/offers/{id}/line-items/{lineItemId}":    {Op: "updateOfferLineItem", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "dynamic"},
	...
	"PATCH /v1/products/{id}":                          {Op: "updateProduct", Access: "tool", Tool: "update_record", RecordType: "product", Tier: "dynamic"},
	...
	"POST /v1/offers/{id}/line-items":                  {Op: "addOfferLineItem", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "dynamic"},
