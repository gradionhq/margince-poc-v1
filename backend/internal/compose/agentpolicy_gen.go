...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/offer-templates/{id}":                                    {Op: "archiveOfferTemplate", Access: "tool", Tool: "archive_record", RecordType: "offer_template", Tier: "yellow"},
	...
	"DELETE /v1/overlay/connection":                                      {Op: "disconnectOverlay", Access: "tool", Tool: "disconnect_incumbent", RecordType: "overlay_connection", Tier: "yellow"},
	...
	"PATCH /v1/webhook-subscriptions/{id}":                               {Op: "updateWebhookSubscription", Access: "tool", Tool: "update_record", RecordType: "webhook_subscription", Tier: "yellow"},
	...
	"POST /v1/offer-templates":                                           {Op: "createOfferTemplate", Access: "tool", Tool: "create_record", RecordType: "offer_template", Tier: "green"},
	...
	"POST /v1/overlay/connection":                                        {Op: "connectOverlay", Access: "tool", Tool: "connect_incumbent", RecordType: "overlay_connection", Tier: "yellow"},
	"POST /v1/overlay/flip":                                              {Op: "executeOverlayFlip", Access: "tool", Tool: "execute_overlay_flip", RecordType: "overlay_connection", Tier: "yellow"},
	"POST /v1/overlay/flip:preflight":                                    {Op: "preflightOverlayFlip", Access: "tool", Tool: "preflight_overlay_flip", RecordType: "overlay_connection", Tier: "green"},
	"POST /v1/overlay/reconcile":                                         {Op: "reconcileOverlay", Access: "tool", Tool: "reconcile_overlay", RecordType: "overlay_connection", Tier: "green"},
	...
	"POST /v1/webhook-subscriptions":                                     {Op: "createWebhookSubscription", Access: "tool", Tool: "create_record", RecordType: "webhook_subscription", Tier: "yellow"},
