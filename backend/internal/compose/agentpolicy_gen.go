...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/leads/{id}/manual-signals/{factor}":                      {Op: "clearLeadManualSignal", Access: "tool", Tool: "clear_lead_manual_signal", RecordType: "lead", Tier: "confirmation_required", Scope: "write"},
	...
	"GET /v1/activities/{id}/meeting-brief":                              {Op: "getMeetingBrief", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/leads/{id}/score":                                           {Op: "explainLeadScore", Access: "tool", Tool: "explain_lead_score", RecordType: "lead", Tier: "auto_execute", Scope: "read"},
	...
	"PATCH /v1/organizations/{id}/facts/{factKey}":                       {Op: "updateOrganizationFact", Access: "tool", Tool: "update_record", RecordType: "organization", Tier: "confirmation_required", Scope: "write"},
	"PATCH /v1/organizations/{id}/profile-fields/{field}":                {Op: "updateOrganizationProfileField", Access: "tool", Tool: "update_record", RecordType: "organization", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/approval-bundles/{bundle_id}/approve":                      {Op: "approveApprovalBundle", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/approval-bundles/{bundle_id}/reject":                       {Op: "rejectApprovalBundle", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/organizations/{id}/profile-fields/{field}/confirm":         {Op: "confirmOrganizationProfileField", Access: "tool", Tool: "update_record", RecordType: "organization", Tier: "confirmation_required", Scope: "write"},
	...
	"PUT /v1/leads/{id}/manual-signals":                                  {Op: "setLeadManualSignal", Access: "tool", Tool: "set_lead_manual_signal", RecordType: "lead", Tier: "confirmation_required", Scope: "write"},
