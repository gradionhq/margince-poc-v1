...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/workspace/email-domains/{domain}":                        {Op: "deleteWorkspaceEmailDomain", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/workspace/email-domains":                                    {Op: "listWorkspaceEmailDomains", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/workspace/email-domains":                                   {Op: "createWorkspaceEmailDomain", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
