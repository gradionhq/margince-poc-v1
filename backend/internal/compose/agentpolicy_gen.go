...
var agentPolicies = map[string]agentPolicy{
	"DELETE /v1/activities/{id}":                                         {Op: "archiveActivity", Access: "tool", Tool: "archive_record", RecordType: "activity", Tier: "confirmation_required"},
	...
	"DELETE /v1/capture/consumer-mail-domains/{id}":                      {Op: "removeConsumerMailDomain", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"DELETE /v1/channel-connections/{id}":                                {Op: "disconnectChannel", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"DELETE /v1/connectors/{provider}/backfill":                          {Op: "cancelConnectorBackfill", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"DELETE /v1/deals/{id}":                                              {Op: "archiveDeal", Access: "tool", Tool: "archive_record", RecordType: "deal", Tier: "confirmation_required"},
	"DELETE /v1/leads/{id}":                                              {Op: "disqualifyLead", Access: "tool", Tool: "disqualify_lead", RecordType: "lead", Tier: "confirmation_required"},
	"DELETE /v1/lists/{id}":                                              {Op: "archiveList", Access: "tool", Tool: "archive_record", RecordType: "list", Tier: "confirmation_required"},
	"DELETE /v1/offer-templates/{id}":                                    {Op: "archiveOfferTemplate", Access: "tool", Tool: "archive_record", RecordType: "offer_template", Tier: "confirmation_required"},
	"DELETE /v1/offers/{id}":                                             {Op: "archiveOffer", Access: "tool", Tool: "archive_record", RecordType: "offer", Tier: "confirmation_required"},
	...
	"DELETE /v1/tags/{id}":                                               {Op: "archiveTag", Access: "tool", Tool: "archive_record", RecordType: "tag", Tier: "confirmation_required"},
	"DELETE /v1/views/{id}":                                              {Op: "archiveSavedView", Access: "tool", Tool: "archive_record", RecordType: "saved_view", Tier: "confirmation_required"},
	...
	"GET /v1/channel-connections":                                        {Op: "listChannelConnections", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"GET /v1/overlay/export":                                             {Op: "downloadOverlayExport", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"PATCH /v1/channel-connections/{id}":                                 {Op: "replaceChannelToken", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"PATCH /v1/deals/{id}":                                               {Op: "updateDeal", Access: "tool", Tool: "update_record", RecordType: "deal", Tier: "auto_execute"},
	"PATCH /v1/leads/{id}":                                               {Op: "updateLead", Access: "tool", Tool: "update_record", RecordType: "lead", Tier: "auto_execute"},
	"PATCH /v1/offers/{id}":                                              {Op: "updateOffer", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "auto_execute"},
	"PATCH /v1/offers/{id}/line-items/{lineItemId}":                      {Op: "updateOfferLineItem", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "auto_execute"},
	"PATCH /v1/organizations/{id}":                                       {Op: "updateOrganization", Access: "tool", Tool: "update_record", RecordType: "organization", Tier: "auto_execute"},
	...
	"PATCH /v1/users/{id}/role":                                          {Op: "changeUserRole", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"PATCH /v1/views/{id}":                                               {Op: "updateSavedView", Access: "tool", Tool: "update_record", RecordType: "saved_view", Tier: "auto_execute"},
	...
	"PATCH /v1/webhook-subscriptions/{id}":                               {Op: "updateWebhookSubscription", Access: "tool", Tool: "update_record", RecordType: "webhook_subscription", Tier: "confirmation_required"},
	"POST /v1/activities":                                                {Op: "logActivity", Access: "tool", Tool: "log_activity", RecordType: "activity", Tier: "auto_execute"},
	"POST /v1/activities/{id}/draft-email":                               {Op: "draftEmail", Access: "tool", Tool: "draft_email", RecordType: "activity", Tier: "auto_execute"},
	"POST /v1/activities/{id}/relink":                                    {Op: "relinkActivity", Access: "tool", Tool: "relink_activity", RecordType: "activity", Tier: "auto_execute"},
	"POST /v1/activities/{id}/send-email":                                {Op: "sendEmail", Access: "tool", Tool: "send_email", RecordType: "activity", Tier: "confirmation_required"},
	"POST /v1/activities/{id}/send-message":                              {Op: "sendMessage", Access: "tool", Tool: "send_message", RecordType: "activity", Tier: "confirmation_required"},
	"POST /v1/admin/reset-data":                                          {Op: "resetData", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/ai-model-rates":                                            {Op: "setAiModelRate", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/ai-model-rates/propose-refresh":                            {Op: "proposeAiModelRateRefresh", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/ai/feedback":                                               {Op: "recordAIFeedback", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/auth/forgot-password":                                      {Op: "requestPasswordReset", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/auth/reset-password":                                       {Op: "resetPassword", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/bookings":                                                  {Op: "bookMeeting", Access: "tool", Tool: "book_meeting", RecordType: "activity", Tier: "confirmation_required"},
	...
	"POST /v1/capture/consumer-mail-domains":                             {Op: "addConsumerMailDomain", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/channel-connections":                                       {Op: "connectChannel", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/custom-fields":                                             {Op: "createCustomField", Access: "tool", Tool: "create_record", RecordType: "custom_field", Tier: "confirmation_required"},
	"POST /v1/custom-fields/{id}/retire":                                 {Op: "retireCustomField", Access: "tool", Tool: "update_record", RecordType: "custom_field", Tier: "confirmation_required"},
	"POST /v1/data-subject-requests":                                     {Op: "createDataSubjectRequest", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/deals":                                                     {Op: "createDeal", Access: "tool", Tool: "create_record", RecordType: "deal", Tier: "auto_execute"},
	"POST /v1/deals/{id}/advance":                                        {Op: "advanceDeal", Access: "tool", Tool: "advance_deal", RecordType: "deal", Tier: "dynamic"},
	"POST /v1/deals/{id}/offers":                                         {Op: "createOffer", Access: "tool", Tool: "create_record", RecordType: "offer", Tier: "auto_execute"},
	"POST /v1/dedupe/candidates/{id}/disposition":                        {Op: "disposeDedupeCandidate", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/dedupe/candidates/{id}/undo":                               {Op: "undoDedupeDisposition", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/embeddings/reindex":                                        {Op: "EmbedReindexStart", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/exports":                                                   {Op: "createFilteredExport", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/fx-rates":                                                  {Op: "setFxRate", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/fx-rates/propose-refresh":                                  {Op: "proposeFxRateRefresh", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/leads":                                                     {Op: "createLead", Access: "tool", Tool: "create_record", RecordType: "lead", Tier: "auto_execute"},
	"POST /v1/leads/{id}/promote":                                        {Op: "promoteLead", Access: "tool", Tool: "promote_lead", RecordType: "lead", Tier: "confirmation_required"},
	"POST /v1/lists":                                                     {Op: "createList", Access: "tool", Tool: "create_record", RecordType: "list", Tier: "auto_execute"},
	"POST /v1/lists/{id}/members":                                        {Op: "addListMember", Access: "tool", Tool: "update_record", RecordType: "list", Tier: "auto_execute"},
	"POST /v1/me/linkedin-connections":                                   {Op: "importLinkedInConnections", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/offer-templates":                                           {Op: "createOfferTemplate", Access: "tool", Tool: "create_record", RecordType: "offer_template", Tier: "auto_execute"},
	"POST /v1/offers/{id}/accept":                                        {Op: "acceptOffer", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/offers/{id}/line-items":                                    {Op: "addOfferLineItem", Access: "tool", Tool: "update_record", RecordType: "offer", Tier: "auto_execute"},
	"POST /v1/offers/{id}/regenerate":                                    {Op: "regenerateOffer", Access: "tool", Tool: "draft_offer", RecordType: "offer", Tier: "auto_execute"},
	"POST /v1/offers/{id}/reject":                                        {Op: "rejectOffer", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/offers/{id}/render":                                        {Op: "renderOffer", Access: "tool", Tool: "render_offer", RecordType: "offer", Tier: "auto_execute"},
	...
	"POST /v1/organizations/{id}/ask":                                    {Op: "askAboutOrganization", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/organizations/{id}/brief":                                  {Op: "regenerateOrganizationBrief", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/people":                                                    {Op: "createPerson", Access: "tool", Tool: "create_record", RecordType: "person", Tier: "auto_execute"},
	...
	"POST /v1/people/{id}/view-ack":                                      {Op: "acknowledgePersonView", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/record-grants":                                             {Op: "createRecordGrant", Access: "tool", Tool: "share_record", RecordType: "record_grant", Tier: "confirmation_required"},
	"POST /v1/relationships":                                             {Op: "createRelationship", Access: "tool", Tool: "create_record", RecordType: "relationship", Tier: "auto_execute"},
	"POST /v1/reports/{report}":                                          {Op: "runReport", Access: "tool", Tool: "run_report", RecordType: "", Tier: "auto_execute"},
	...
	"POST /v1/tags":                                                      {Op: "createTag", Access: "tool", Tool: "create_record", RecordType: "tag", Tier: "auto_execute"},
	"POST /v1/tags/{id}/apply":                                           {Op: "applyTag", Access: "tool", Tool: "update_record", RecordType: "tag", Tier: "auto_execute"},
	"POST /v1/users":                                                     {Op: "inviteUser", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/users/{id}/deactivate":                                     {Op: "deactivateUser", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/users/{id}/reactivate":                                     {Op: "reactivateUser", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/views":                                                     {Op: "createSavedView", Access: "tool", Tool: "create_record", RecordType: "saved_view", Tier: "auto_execute"},
	"POST /v1/voice-profiles":                                            {Op: "createVoiceProfile", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/voice-profiles/{id}/builds":                                {Op: "createVoiceBuild", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/webhook-subscriptions":                                     {Op: "createWebhookSubscription", Access: "tool", Tool: "create_record", RecordType: "webhook_subscription", Tier: "confirmation_required"},
	"POST /v1/webhook-subscriptions/{id}/deliveries/{deliveryId}/replay": {Op: "replayWebhookDelivery", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/webhook-subscriptions/{id}/rotate-secret":                  {Op: "rotateWebhookSecret", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"PUT /v1/company":                                                    {Op: "putCompany", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"PUT /v1/me/linkedin-account":                                        {Op: "saveMyLinkedInAccount", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
