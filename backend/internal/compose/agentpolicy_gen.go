...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/capture/exclusions/{id}":                                 {Op: "deleteCaptureExclusion", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/me/linkedin-connections/{id}/confirm":                      {Op: "confirmLinkedInMatch", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	"POST /v1/me/linkedin-connections/{id}/reject":                       {Op: "rejectLinkedInMatch", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
