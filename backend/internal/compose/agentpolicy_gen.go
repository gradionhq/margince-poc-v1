...
var agentPolicies = map[string]agentPolicy{
	"DELETE /v1/activities/{id}":                                         {Op: "archiveActivity", Access: "tool", Tool: "archive_record", RecordType: "activity", Tier: "confirmation_required", Scope: "write"},
	...
	"DELETE /v1/leads/{id}":                                              {Op: "disqualifyLead", Access: "tool", Tool: "disqualify_lead", RecordType: "lead", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/lists/{id}":                                              {Op: "archiveList", Access: "tool", Tool: "archive_record", RecordType: "list", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/offer-templates/{id}":                                    {Op: "archiveOfferTemplate", Access: "tool", Tool: "archive_record", RecordType: "offer_template", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/offers/{id}":                                             {Op: "archiveOffer", Access: "tool", Tool: "archive_record", RecordType: "offer", Tier: "confirmation_required", Scope: "write"},
	...
	"DELETE /v1/organizations/{id}":                                      {Op: "archiveOrganization", Access: "tool", Tool: "archive_record", RecordType: "organization", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/overlay/connection":                                      {Op: "disconnectOverlay", Access: "tool", Tool: "disconnect_incumbent", RecordType: "overlay_connection", Tier: "confirmation_required", Scope: "write"},
	...
	"DELETE /v1/people/{id}":                                             {Op: "archivePerson", Access: "tool", Tool: "archive_record", RecordType: "person", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/products/{id}":                                           {Op: "archiveProduct", Access: "tool", Tool: "archive_record", RecordType: "product", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/projects/{id}":                                           {Op: "archiveProject", Access: "tool", Tool: "archive_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/projects/{id}/stakeholders/{person_id}":                  {Op: "removeProjectStakeholder", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
	"DELETE /v1/quotas/{id}":                                             {Op: "archiveQuota", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"DELETE /v1/record-grants/{id}":                                      {Op: "revokeRecordGrant", Access: "tool", Tool: "share_record", RecordType: "record_grant", Tier: "confirmation_required", Scope: "write"},
	...
	"GET /v1/deals":                                                      {Op: "listDeals", Access: "tool", Tool: "search_records", RecordType: "deal", Tier: "auto_execute", Scope: "read"},
	...
	"GET /v1/leads":                                                      {Op: "listLeads", Access: "tool", Tool: "search_records", RecordType: "lead", Tier: "auto_execute", Scope: "read"},
	...
	"GET /v1/organizations":                                              {Op: "listOrganizations", Access: "tool", Tool: "search_records", RecordType: "organization", Tier: "auto_execute", Scope: "read"},
	...
	"GET /v1/people":                                                     {Op: "listPeople", Access: "tool", Tool: "search_records", RecordType: "person", Tier: "auto_execute", Scope: "read"},
	...
	"GET /v1/projects":                                                   {Op: "listProjects", Access: "tool", Tool: "search_records", RecordType: "project", Tier: "auto_execute", Scope: "read"},
	...
	"GET /v1/users":                                                      {Op: "listUsers", Access: "tool", Tool: "search_records", RecordType: "app_user", Tier: "auto_execute", Scope: "read"},
	...
	"PATCH /v1/projects/{id}":                                            {Op: "updateProject", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/activities/{id}/relink":                                    {Op: "relinkActivity", Access: "tool", Tool: "relink_activity", RecordType: "activity", Tier: "auto_execute", Scope: "write"},
	...
	"POST /v1/activities/{id}/send-message":                              {Op: "sendMessage", Access: "tool", Tool: "send_message", RecordType: "activity", Tier: "confirmation_required", Scope: "send"},
	...
	"POST /v1/approvals/{id}/approve":                                    {Op: "approveApproval", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/approvals/{id}/reject":                                     {Op: "rejectApproval", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/bookings":                                                  {Op: "bookMeeting", Access: "tool", Tool: "book_meeting", RecordType: "activity", Tier: "confirmation_required", Scope: "send"},
	...
	"POST /v1/coldstart":                                                 {Op: "coldStartReadback", Access: "tool", Tool: "enrich", RecordType: "", Tier: "confirmation_required", Scope: "enrich"},
	"POST /v1/coldstart/preview":                                         {Op: "coldStartPreview", Access: "tool", Tool: "enrich", RecordType: "", Tier: "confirmation_required", Scope: "enrich"},
	...
	"POST /v1/offers/{id}/regenerate":                                    {Op: "regenerateOffer", Access: "tool", Tool: "draft_offer", RecordType: "offer", Tier: "auto_execute", Scope: "write"},
	"POST /v1/offers/{id}/reject":                                        {Op: "rejectOffer", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/offers/{id}/render":                                        {Op: "renderOffer", Access: "tool", Tool: "render_offer", RecordType: "offer", Tier: "auto_execute", Scope: "write"},
	"POST /v1/offers/{id}/send":                                          {Op: "sendOffer", Access: "tool", Tool: "send_offer", RecordType: "offer", Tier: "confirmation_required", Scope: "send"},
	...
	"POST /v1/organizations/{id}/merge":                                  {Op: "mergeOrganization", Access: "tool", Tool: "merge_records", RecordType: "organization", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/overlay/connection":                                        {Op: "connectOverlay", Access: "tool", Tool: "connect_incumbent", RecordType: "overlay_connection", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/overlay/reconcile":                                         {Op: "reconcileOverlay", Access: "tool", Tool: "reconcile_overlay", RecordType: "overlay_connection", Tier: "auto_execute", Scope: "enrich"},
	...
	"POST /v1/projects":                                                  {Op: "createProject", Access: "tool", Tool: "create_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/record-grants":                                             {Op: "createRecordGrant", Access: "tool", Tool: "share_record", RecordType: "record_grant", Tier: "confirmation_required", Scope: "write"},
	...
	"POST /v1/tags":                                                      {Op: "createTag", Access: "tool", Tool: "create_record", RecordType: "tag", Tier: "auto_execute", Scope: "write"},
