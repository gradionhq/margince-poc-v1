...
var agentPolicies = map[string]agentPolicy{
	...
	"PATCH /v1/webhook-subscriptions/{id}":             {Op: "updateWebhookSubscription", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
	...
	"POST /v1/webhook-subscriptions":                   {Op: "createWebhookSubscription", Access: "human-only", Tool: "", RecordType: "", Tier: ""},
