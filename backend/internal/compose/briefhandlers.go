...
// briefHandlers wires the brief transport to the engine.
type briefHandlers struct {
	engine *BriefEngine
}
...
func (h briefHandlers) GetMorningBrief(w http.ResponseWriter, r *http.Request) {
...
func (h briefHandlers) GenerateMorningBrief(w http.ResponseWriter, r *http.Request) {
...
func (h briefHandlers) MarkBriefItemActed(w http.ResponseWriter, r *http.Request, itemID openapi_types.UUID) {
...
func (h briefHandlers) MarkBriefItemDismissed(w http.ResponseWriter, r *http.Request, itemID openapi_types.UUID) {
