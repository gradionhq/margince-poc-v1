...
// of what a backfill window would spend. It is the ONLY money-aware code in the
// tree; the modules it reads never import one another. Cost here is transparency,
// never a gate (ADR-0020, NEVER-4): an unpriced estimate is suppressed, never
// fabricated.
